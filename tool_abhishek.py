...
class App:
    def __init__(self, window, snippet_length, category_keyword_dict):
        ...
        ##################################################################
        ## GUI design
        self.container_button_label_video_at_left = tk.Frame(self.window)
        ...
        self.textbox_json = tk.Text(self.window, height=1.5, width=7)
        ...
        #b_check.pack(in_=hor_fr, side=tk.LEFT)
        ...
        self.container_button_label_video_at_left.pack(side=tk.LEFT, anchor=tk.NW)

        self.textbox_json.pack(expand=tk.YES, fill=tk.BOTH)
    ...
    def create_checklist(self):
        ...
        self.container_categories.pack(side=tk.BOTTOM)
